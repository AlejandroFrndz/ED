...
private:
    ...
    */
    pair<bool,int> BBinaria_d(int inicio, int fin, const ingrediente& ing) const;
    /**
    ...
    @return  false,inicio si no se encuentra el ingrediente, true,pos si se halla el ingrediente    
    */
    pair<bool,int> BBinaria_i(int inicio, int fin, const ingrediente& ing) const;
    /**
    ...
    @return  false,inicio si no se encuentra el ingrediente, true,pos si se halla el ingrediente    
    */
    pair<bool,int> BBinaria_nombre(int inicio, int fin, string n) const;
    /**
    ...
    @return  false,inicio si no se encuentra el ingrediente, true,pos si se halla el ingrediente    
    */
    pair<bool,int> BBinaria_tipo(int inicio, int fin, string tipo) const;
    /**
    @brief busqueda binaria del ingrediente dentro del vector de datos
    @param ing: ingrediente a buscar
    @return false,inicio si no se encuentra el ingrediente, true,pos si se halla el ingrediente
    */
    pair<bool,int> esta_d(const ingrediente& ing) const;
    /**
    @brief busqueda binaria del ingrediente dentro del vector de indices
    @param ing: ingrediente a buscar
    @return false,inicio si no se encuentra el ingrediente, true,pos si se halla el ingrediente
    */
    pair<bool,int> esta_i(const ingrediente& ing) const;
